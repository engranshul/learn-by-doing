...
View can be nested and view can have a style hving width and height
spread operator used with colors example ...colors (spread it used only wd iterable instance like array)
