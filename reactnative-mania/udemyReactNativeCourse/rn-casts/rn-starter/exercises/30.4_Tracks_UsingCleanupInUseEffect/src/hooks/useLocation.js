...
it could be possible that we create multiple subscribers 
to the same location event
...
To solve this we gonna remove subscriber before creating a new
one by using clean up in use effect

SO it works like this :
*useLocationFirstCall : return clean up function
*useLocationSecondCall : first run clean up function returned from 1st
time and than start watching
