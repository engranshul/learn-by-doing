// learnings is that in order to maintain ordering in responses 
// we have to keep a data structure : var responses = {};
...
function fileReceived(file,text) {
	...
	for (var i=0; i<files.length; i++) {
		// response received?...check same in response object
